...
```python
import sys; sys.path.insert(0, '/nix/store/kl5lh42dcv24j6dn5f0wq2g5pxyzjk2d-python3-3.13.11-env/lib/python3.13/site-packages'); sys.path.insert(0, '/nix/store/8s2vmxd4dplgq4cygmdd5pzs0nn2n1h6-spec-kitty-0.13.7/lib/python3.13/site-packages'); from specify_cli.agent_utils.status import show_kanban_status
